...
public class WeightedEnumSelectorStrategy<E extends Enum<E> & WeightedEnumData> implements SelectorStrategy<E> {

    @SuppressWarnings("unused")
    private static final Logger LOGGER = LoggerFactory.getLogger(WeightedEnumSelectorStrategy.class);
    ...
    public RandomSelector<E> buildSelector(Map<E, Double> weights, TemplateField field){
        ...
        return new WeightedEnumSelectorImpl<>(enumSet, field);
    }
    ...
    public E select(Map<E, Double> map, TemplateField field) {
        ...
        RandomSelector<E> selector = new WeightedEnumSelectorImpl<>(enumSet, field);
